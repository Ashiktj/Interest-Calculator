    ...
    <div className="App">
      <div className="container">
        <div className="header">
          ...
          <p>Calculate your simole interest with us❤️</p>
        </div>
        ...
        <div className="form">
          <form action>
            <div className="input">
             ...
             <br /> <TextField id="filled-basic" value={year||''} onChange={(e)=>setYear(e.target.value)} label="Year" variant="standard" />
             <br /> <TextField id="standard-basic" value={rate||''} onChange={(e)=>setRate(e.target.value)} label="Rate" variant="standard" />
            </div>
